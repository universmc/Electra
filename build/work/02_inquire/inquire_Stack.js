...
async function main() {
  ...
  const questions = [
    ...
    },
    {
      ...
      choices: ['Node.js', 'PHP','SQL','CVS', 'JS/JSON','PHP/SQL','JS/JSON'],
    ...
    },
    {
      ...
      choices: ['MySQL','JSON','IDX','OVH','express','firebase',],
      when: (answers) => answers.section === 'Backend',
    },
    {
      type: 'list',
      ...
      choices: ['Express.js','swagger.js','ThreeJs','electronJS','groq-sdk','OBserver','Blender','Davinci_resolve','KerrasJS','Tensorflows','phpmyadmin','package.js','Makefile','ThreeJs','electronJs','menu.sh',],
